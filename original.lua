...
local Color3 = {} do
    ...
    function Color3.fromHex(Hex)
        assert(type(Hex) == "string" and #Hex == 6, "Hex color must be a 6-character string")
    ...
    function Color3.new(R, G, B)
        assert(type(R) == "number" and type(G) == "number" and type(B) == "number", "Color3 constructor requires three numeric arguments")
    ...
    function Color3.__eq(This, Other) return This[1] == Other[1] and This[2] == Other[2] and This[3] == Other[3] end
    function Color3.__tostring(This) return `Color.new({This[1]}, {This[2]}, {This[3]})` end

    function Color3.__add(This, Other) if type(Other) == "table" and Other[1] and Other[2] and Other[3] then return Color3.fromRGB(This[1] + Other[1], This[2] + Other[2], This[3] + Other[3]) end return error(`can't add {type(Other)} to Color`) end
    function Color3.__sub(This, Other) if type(Other) == "table" and Other[1] and Other[2] and Other[3] then return Color3.fromRGB(This[1] - Other[1], This[2] - Other[2], This[3] - Other[3]) end return error(`can't subtract {type(Other)} from Color`) end
    function Color3.__mul(This, Other) if type(Other) == "table" and Other[1] and Other[2] and Other[3] then return Color3.fromRGB(This[1] * Other[1], This[2] * Other[2], This[3] * Other[3]) elseif type(Other) == "number" then return Color3.fromRGB(This[1] * Other, This[2] * Other, This[3] * Other) end return error(`can't multiply {type(Other)} with Color`) end
    function Color3.__div(This, Other) if type(Other) == "table" and Other[1] and Other[2] and Other[3] then return Color3.fromRGB(This[1] / Other[1], This[2] / Other[2], This[3] / Other[3]) elseif type(Other) == "number" then return Color3.fromRGB(This[1] / Other, This[2] / Other, This[3] / Other) end return error(`can't divide {type(Other)} from Color`) end
